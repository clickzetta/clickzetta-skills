# Client, Connector, SDK Download

This page provides download links for the Lakehouse command line client, JDBC driver, ecosystem tool Connectors, and programming language SDKs.

* Command line client: [Download package](https://autolake-dev-beijing.oss-cn-beijing.aliyuncs.com/clickzetta-tool/release/sqlline_cz.tar.gz).
