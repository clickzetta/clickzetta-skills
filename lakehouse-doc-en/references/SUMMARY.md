...
* [Overview](overview.md)
    ...
    * [Editions Overview](EditionsOverview.md)
* [Concept](concepts.md)
...
* [Pricing and Billing](pricing.md)
    ...
    * [Analytics Agent Pricing](pricing-analytics-agent.md)
* [Tutorials](tutorials.md)
    ...
    * [A Comprehensive Guide to Ingesting Data into Singdata Lakehouse](a_comprehensive_guide_to_ingesting_data_into_clickzetta_lakehouse.md)
        ...
        * [CDC and Data Processing via Multi-Table Real-Time Sync and Dynamic Tables](czguide-intro-to-cdc-using-clickzetta-rtsync-dynamic-tables.md)
...
* [Object Model](object_model_design.md)
    ...
    * [Data Tables](table-overview.md)
        ...
        * [External Table Overview](external-table-guide.md)
            ...
            * [Paimon External Table](paimon_external_table_guide.md)
            * [Iceberg External Table](iceberg_external_catalog_guide.md)
...
* [Data Analysis and SQL Guide](analysis.md)
    * [Data Query and Analysis](sql_query_analysis_guide.md)
        ...
        * [Group Bitmap User Overlap Analysis](SQL_Bitmap_Overlap_Guide.md)
        * [IP Geolocation and Security Analysis](SQL_IP_Geo_Analysis_Guide.md)
...
* [Data Lake Management and Analytics](datalake_volume_analytics.md)
    ...
    * [Private Storage BYOS](bring_your_own_storage.md)
        ...
        * [BYOS Configuration via RAM Role](lakehouse-byos-ram-role-guide.md)
...
* [Security](data_security.md)
    ...
    * [Identity Authentication](identity-auth.md)
        * [Bind a Virtual MFA Device](using-google-authenticator.md)
...
* [Lakehouse AI Overview](lakehouseai-overview.md)
    * [Singdata Insight: Visual Data Analytics Platform](lakehouse-insight.md)
    ...
    * [AI Functions](ai_function_in_sql.md)
        ...
        * [AI_CONTEXT_LENGTH](ai_context_length.md)
...
* [AI Gateway](aigateway.md)
    * [AI Gateway Product Overview](AI_Gateway.md)
    * [Product Introduction](introduction.md)
    * [Using Models](use-models.md)
    * [Model Types](aigw_model_types.md)
    * [Model Price](modelprice.md)
    * [Service Tier Introduction](aigw_tier_Introduction.md)
    ...
    * [Tool Calling Instructions](aigw_tool_calling_Instructions.md)
        * [WorkBuddy Configuration Guide](aigw_workbuddy_calling.md)
        * [OpenClaw Configuration Guide](aigw_openclaw_calling.md)
        * [Codex CLI Configuration Guide](aigw_codex_calling.md)
        * [TRAE International Edition Configuration Guide](aigw_trae_calling.md)
        * [Kilo Code Configuration Guide](aigw_kilo_calling.md)
        * [OpenCode Configuration Guide](aigw_opencode_calling.md)
* [Conversational Analytics (Analytics Agent)](datagpt_introduction.md)
    * [Quick Start](datagpt_quickstart.md)
    * [Conversational Data Analytics Guide](conversational_analytics_datagpt.md)
    * [Usage Guide](datagpt-role-based-usage-guide.md)
    * [Analyst Guide](datagpt-analyst-guide.md)
        * [Recommended Questions Configuration](datagpt-recommended-questions-guide.md)
        * [Knowledge Base](datagpt-knowledge-base-guide.md)
        * [Data and Exploration](datagpt-data-exploration-guide.md)
        ...
        * [Evaluation Guide](datagpt-evaluation-guide.md)
        * [Analysis Patterns Guide](datagpt-analysis-patterns-guide.md)
        * [Reading Analysis Results](datagpt-answer-reading-guide.md)
        * [Answer Explainability](datagpt-answer-explainability-guide.md)
        ...
        * [Scheduled Tasks](scheduled_task.md)
        ...
        * [Customize Logo, Theme, and Chart Colors](datagpt-user-settings-guide.md)
    * [Configuration Guide](datagpt_tutorial.md)
        ...
        * [Configure Virtual Columns](datagpt-virtual-column-config-guide.md)
        * [Configure Knowledge](datagpt-knowledge-config-best-practices.md)
        * [File and Document Q&A](datagpt-file-knowledge-qa-guide.md)
    ...
    * [Best Practices](datagpt_bestpractice.md)
        * [From PoC to Production: Analytics Agent Deployment Guide](datagpt-production-adoption-guide.md)
        * [Domain Configuration Principles and FAQ](datagpt-domain-setup-tips.md)
        * [Domain Modeling with cz-cli for Analytics Agent](datagpt-domain-modeling-by-czcli-guide.md)
        * [Answer Builder SQL Template Guide](datagpt-answer-builder-sql-guide.md)
        * [Metric Definition System and Validation Operations Guide](datagpt-semantic-governance-guide.md)
        * [Answer Builder Best Practices](datagpt-answer-builder-best-practices.md)
        * [Answer Accuracy Improvement - Best Practices](answer-accuracy-improve.md)
        * [Troubleshoot Q&A Accuracy Issues](datagpt-qa-accuracy-troubleshooting-guide.md)
        * [Pre-Launch Domain Health Check](datagpt-domain-health-check-and-launch-checklist.md)
    ...
    * [Governance](datagpt-governance-overview.md)
        * [Manage Permissions](datagpt-permission-management-guide.md)
        * [Configure Role Authorization](datagpt-role-authorization-guide.md)
        * [Configure Row-Level Permissions](datagpt-row-level-permission-guide.md)
        * [Manage Domain Resource Permissions](datagpt-domain-resource-permission-guide.md)
...
* [Data Engineering Agent](dataagent.md)
    * [Getting Started](dataagent-getting-started.md)
        * [Basic Usage Scenarios](dataagent-basic-usage-scenarios.md)
        * [Common Prompt Templates](dataagent-prompt-examples.md)
        * [End-to-End Tutorial](dataagent-end-to-end-tutorial.md)
    * [Development](dataagent-development-guide.md)
        ...
        * [Task Group and Composite Task Best Practices](dataagent-task-group-best-practices.md)
        * [Safe Operation Guide](dataagent-safe-operation-guide.md)
    * [Modeling and Publishing](dataagent-modeling-and-release-guide.md)
        * [Data Pipeline and Data Warehouse Modeling Guide](dataagent-data-pipeline-guide.md)
        * [Metric Specification Design Guide](dataagent-metric-design-guide.md)
        * [Metric to Data Warehouse Build Guide](dataagent-metric-to-warehouse-guide.md)
    ...
    * [Operations and Quality](dataagent-operations-and-quality-guide.md)
        * [Run Monitoring Guide](dataagent-monitoring-guide.md)
        * [Task Diagnosis Guide](dataagent-job-diagnosis-guide.md)
        * [DQC Data Quality Rules Guide](dataagent-dqc-guide.md)
        * [DQC Best Practices](dataagent-dqc-best-practices.md)
    * [Reference](dataagent-reference.md)
        * [Common Misconceptions](dataagent-common-misunderstandings.md)
        * [How to Guide the Agent to Operate Studio Correctly](studio-agent-operation-guide.md)
        * [Production Readiness Guide](dataagent-production-readiness-guide.md)
    * [Best Practices](dataagent_bestpractice.md)
        * [From Requirements to Semantic Layer: Metric Definition Management Best Practices](dataagent_metric_semanticview_practise.md)
    * [Skills Library](Skills.md)
* [Singdata CLI (cz-cli)](cz-cli.md)
    * [Installation, Agent, and MCP Configuration Guide](setup_cz_cli.md)
...
* [MCP Server (Studio-hosted, recommended)](MCPServers.md)
    ...
    * [Studio MCP: Working with SQL Tasks](studio-mcp-sql-task-guide.md)
    * [Studio MCP: Working with Python Tasks](studio-mcp-python-task-guide.md)
    * [Studio MCP: Working with Offline Sync Tasks](studio-mcp-offline-integration-task-guide.md)
    * [Studio MCP: The Offline-Sync-to-SQL ELT Workflow](studio-mcp-offline-sync-to-sql-elt-guide.md)
    * [Studio MCP: Configuring Task Parameters and Scheduling](studio-mcp-parameters-and-scheduling-guide.md)
    * [Studio MCP: Publishing, Unpublishing, and Run Diagnosis](studio-mcp-release-and-diagnosis-guide.md)
    * [Studio MCP: Working with Data Integration Tasks](studio-mcp-integration-task-guide.md)
    * [Studio MCP: Working with Multi-Table Real-Time Sync Tasks](studio-mcp-cdc-realtime-sync-guide.md)
...
* [SQL Statements](sql-commands.md)
    ...
    * [Data Export Overview](unload-data-summary.md)
        ...
        * [COPY FILES (Copy Between Volumes)](copy-files-into-volume.md)
...
* [Java SDK](java_sdk_guide.md)
    ...
    * [Batch Data Ingestion (Bulkload)](java_reference/bulkload.md)
    * [Bulkload Java SDK (Quick Start)](java_reference/bulkload-upload.md)
...
* [Python SDK (SQL Interface)](python_sdk_guide.md)
    ...
    * [Bulkload Python SDK (Quick Start)](python_reference/bulkload-upload.md)
...
* [Develop Custom Functions](RemoteFunction-as-udf.md)
    * [SQL Custom Functions Guide](sql-function-guide.md)
...
* [Federation Query](federation-query.md)
    * [External Object (Catalog, Schema, Table) Usage Guide](external_object_user_guide.md)
    * [Accessing Snowflake OpenCatalog Iceberg Tables via External Catalog](query-snowflake-open-catalog-iceberg-table.md)
    ...
    * [Databricks-Singdata Cross-Platform Data Federation Best Practices](databricks_yunqi_integration_guide_v2.md)
...
## Use Cases
* [Use Cases Overview](solutions/usage_scenarios_overview.md)
* [Autonomous Driving](solutions/autonomous-driving-full-loop.md)
* [Smart Mining](solutions/smart-mine.md)
* [Industrial Defect Detection](solutions/defect-detection-ai.md)
* [Industrial Equipment Predictive Maintenance](solutions/predictive-maintenance.md)
* [Supply Chain Inventory Optimization](solutions/supply-chain-inventory.md)
* [Intelligent Customer Complaint Handling](solutions/complaint-labeling.md)
* [Product Review Sentiment Analysis](solutions/product-review-sentiment.md)
* [Email Customer Support Auto-Triage](solutions/email-customer-support.md)
* [User Behavior Funnel Analysis](solutions/user-behavior-funnel.md)
* [Industrial IoT Device Health Monitoring](solutions/iot-device-health-monitoring-dw-best-practices.md)
* [Gaming Operations Data Warehouse](solutions/gaming-operations-dw-best-practices.md)
* [Retail Chain Store Operations Data Warehouse](solutions/retail-chain-pos-dw-best-practices.md)
* [SaaS Multi-Tenant Operations Data Warehouse](solutions/saas-operations-dw-best-practices.md)
* [Digital Marketing CDP with Unified User ID](solutions/marketing-cdp-dw-best-practices.md)
* [Financial Fraud Ring Detection](solutions/fraud-graph-detection-dw-best-practices.md)
* [Supply Chain and Logistics Tracking Data Warehouse](solutions/supply-chain-logistics-dw-best-practices.md)
* [Real-Time Financial Risk Control Data Warehouse](solutions/financial-risk-control-realtime-dw-best-practices.md)
* [Healthcare Operations Data Warehouse](solutions/healthcare-operations-dw-best-practices.md)
* [Smart City Data Platform](solutions/smart-city-data-platform-best-practices.md)
* [Online Education Learning Behavior Data Warehouse](solutions/online-education-dw-best-practices.md)
* [SKU-Level Demand Forecasting Data Warehouse](solutions/sku-demand-forecasting-dw-best-practices.md)
* [Multi-Channel Ad Attribution Data Warehouse](solutions/ad-attribution-dw-best-practices.md)
* [Energy Time-Series Data Warehouse](solutions/energy-timeseries-dw-best-practices.md)
* [SOC Log Analysis Data Warehouse](solutions/soc-log-analysis-dw-best-practices.md)
* [Multi-Engine Iceberg Data Lake Federation](solutions/iceberg-federation-pipeline-best-practices.md)
* [Enterprise Data Mesh Productization](solutions/data-mesh-productization-best-practices.md)
* [DataOps Pipeline Quality Gates](solutions/dataops-quality-gates-best-practices.md)
* [Retail Customer 360 Churn Prediction](solutions/retail-customer-360-dw-best-practices.md)
* [Ride-Hailing Supply-Demand Analysis Data Warehouse](solutions/ride-hailing-operations-dw-best-practices.md)
* [Content Platform Recommendation System Data Warehouse](solutions/content-recommendation-dw-best-practices.md)
* [Insurance Core Business Compliance Reporting](solutions/insurance-compliance-dw-best-practices.md)
* [Manufacturing SPC Quality Control Data Warehouse](solutions/manufacturing-spc-dw-best-practices.md)
* [Healthcare FHIR Clinical Data Analysis](solutions/fhir-clinical-dw-best-practices.md)
* [HR Employee Lifecycle Data Warehouse](solutions/hr-employee-lifecycle-dw-best-practices.md)
* [Media Copyright Monitoring and Royalty Settlement](solutions/copyright-royalty-settlement-dw-best-practices.md)
* [Regulatory Reporting Data Warehouse (BCBS 239 / IFRS 9)](solutions/regulatory-reporting-dw-best-practices.md)
* [Weather × Retail Cross-Analysis](solutions/weather-retail-cross-analysis-best-practices.md)
* [Marketing Attribution and Uplift Modeling](solutions/marketing-uplift-modeling-dw-best-practices.md)
* [Product Analytics Data Warehouse (Funnel + A/B Testing)](solutions/product-analytics-dw-best-practices.md)

## Release Notes
* [Release Notes](releasenotes.md)
    * [Lakehouse Studio Release Notes](lakehouse-studio-release-note.md)
        * [July 28, 2026 - 2.3.1 & v2.3.2](rn_2026-07-28_2.3.1.md)
        * [July 8, 2026 - 2.3.0](rn_2026-07-08_2.3.0.md)
        * [July 1, 2026 - 2.3.0 (Data Agent)](rn_2026-07-01.md)
        * [June 16, 2026 - 2.2.1](rn_2026-06-16.md)
    ...
    * [Lakehouse Platform Release Notes](lakehouse-platform-release-note.md)
        * [August 21, 2026](rn_lh_2026-08-21.md)
    ...
    * [Analytics Agent Release Notes](datagpt-release.md)
        ...
        * [July 31, 2026](release-note-2026-07-31.md)
    * [AI Gateway Release Notes](aigatewayupdate.md)
        * [February 5, 2026 - 1.0](2026_05_12_111.md)
        ...
        * [August 10, 2026 - 2.0](aigw-2026-8-10-2.0.md)
