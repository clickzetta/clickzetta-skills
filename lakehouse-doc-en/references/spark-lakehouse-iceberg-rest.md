...
| spark.sql.catalog.clickzetta\_catalog.uri                                | The API endpoint address of the REST Catalog service. Spark sends all metadata management requests (e.g., create table, get table info) to this URL.                                                                                                                                                                                                                    | https\://{endpoint}/api/v1/catalog/iceberg-rest. For the endpoint value, refer to the [documentation](supported-cloud-platforms.md)                                         | Yes                  |
