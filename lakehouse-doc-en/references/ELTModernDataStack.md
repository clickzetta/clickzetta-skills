...
  Once the data enters the Singdata Lakehouse, the next step is how to analyze the data. Please read: [Building an Analytics-Oriented Modern Data Stack Based on Singdata Lakehouse](eltmoderndatastack.md)
